...
define('myyshop', true);
    ...
    $_SESSION['urlpage'] = "<a href='index.php'>Главная</a> \ <a href='edit_administrators.php'>Изменение управляющего персонала</a>";
...
<head>
	...
	<title>Панель управления - Изменение управляющего персонала</title>
</head>
...
<p id="title-page">Изменение управляющего персонала</p>
</div>
...
if ($row["delivery_orders"] == "1") $delivery_orders = "checked";
...
<ul class="privilege">
<li><h3>Управляющий персонал</h3></li>

<li>
<input type="checkbox" name="view_admin" id="view_admin" value="1" '.$view_admin.' />
<label for="view_admin">Просмотр управляющего персонала.</label>
</li>
