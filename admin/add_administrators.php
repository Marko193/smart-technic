...
define('myyshop', true); 
    ...
    $_SESSION['urlpage'] = "<a href='index.php'>Главная</a> \ <a href='add_administrators.php'>Добавление управляющего персонала</a>"; 
    ...
    if ($_POST["submit_add"])
{
 ...
 }else
 {
          ...
          $_SESSION['message'] = "<p id='form-success'>Новый управляющий был успешно добавлен!</p>";
 } 
 }  else
    {
       $msgerror = 'У вас нет прав на добавление управляющего персонала!'; 
    } 
 }
?>
<!DOCTYPE HTML>
...
<head>
	...
	<title>Панель управления - Добавление управляющего персонала</title>
</head>
...
<p id="title-page">Добавление управляющего персонала</p>
</div>
