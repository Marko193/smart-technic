...
define('myyshop', true);
    ...
    $_SESSION['urlpage'] = "<a href='index.php'>Главная</a> \ <a href='categor.php'>Категории</a>";
...
if ($_POST["submit_cat"])
{
  ...
  }else
  {
     ...
     $cat_brand = clear_string($_POST["cat_brand"]);
                       mysql_query("INSERT INTO categories(type,brand)
						VALUES(						
                            '".$cat_type."',
                            '".$cat_brand."'                              
						)",$link);
...
<?php
	$result = mysql_query("SELECT * FROM categories ORDER BY type DESC",$link);
