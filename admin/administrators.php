...
define('myyshop', true);
    ...
    $_SESSION['urlpage'] = "<a href='index.php'>Главная</a> \ <a href='administrators.php'>Управляющий персонал</a>";
...
<head>
	...
	<title>Панель управления - Управляющий персонал</title>
</head>
...
<p id="title-page" >Управляющий персонал</p>
<p align="right" id="add-style"><a href="add_administrators.php">Добавить управляющего</a></p>
</div>
...
<a class="green" href="edit_administrators.php?id='.$row["id"].'" >Изменить</a> | 
<a class="delete" href="administrators.php?id='.$row["id"].'&action=delete" >Удалить</a>
</p>
</li>
</ul>   
    ';    
