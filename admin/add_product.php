...
define('myyshop', true);
 ...
 if($_SESSION['add_tovar'] == '1')
 {
      ...
      {
       	$result = mysql_query("SELECT * FROM categories WHERE id='{$_POST["form_category"]}'",$link);
       ...
       {             
              		mysql_query("INSERT INTO table_products(title,price,brand,seo_words,seo_description,mini_description,description,mini_features,features,new,leader,sale,visible,product_type,brand_id)
						VALUES(						
                            '".$_POST["form_title"]."',
                            '".$_POST["form_price"]."',
                            '".$selectbrand."',
...
<?php
	$category = mysql_query("SELECT * FROM categories",$link);
...
if ($row["type_tovara"] == "mobile") $type_mobile = "selected";
if ($row["type_tovara"] == "notebook") $type_notebook = "selected";
if ($row["type_tovara"] == "tablet") $type_notepad = "selected";
do
{
