<?php
    ...
    if ( $_SESSION['auth'] == 'yes_auth' ) 
 {
    ...
    mysql_query("INSERT INTO orders(order_datetime,order_dostavka,order_fio,order_address,order_phone,order_note,order_email,define_session)
						VALUES(	
                             NOW(),
...
<?php
    ...
    switch($action)
    {
        ...
        <p align="right"><input type="submit" name="submitdata" id="confirm-button-next" value="Подтвердить" /></p>
            ';
        }
        else
        {
...
<input type="text" name="info_surname" id="info_surname" value="'.$_SESSION['auth_surname'].'" readonly/>
</li>

<li>
<label for="info_name">Имя</label>
<input type="text" name="info_name" id="info_name" value="'.$_SESSION['auth_name'].'" readonly/>
</li>

<li>
<label for="info_patronymic">Отчество</label>
<input type="text" name="info_patronymic" id="info_patronymic" value="'. $_SESSION['auth_patronymic'].'" readonly/>
</li>

<li>
<label for="info_email">E-mail</label>
<input type="text" name="info_email" id="info_email" value="'. $_SESSION['auth_email'].'" readonly/>
</li>

<li>
<label for="info_phone">Телефон</label>
<input type="text" name="info_phone" id="info_phone" value="'. $_SESSION['auth_phone'].'" readonly/>
</li>

<li>
<label for="info_address">Адрес доставки</label>
<input type="text" name="info_address" value="'. $_SESSION['auth_address'].'" readonly/>
</li>
        ...
        <p>Шаг 3 из 3</p>     
        <a href="cart.php?action=clear">В начало</a>               
        </div> 
         <div class="reg_message_good">Спасибо! Ваш заказ был успешно оформлен!</div>        
        ...
        echo '
            ...
            <p align="right" class="button-next" ><a href="index.php">Отлично!</a></p>            
            ';
